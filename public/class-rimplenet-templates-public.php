 ...
 * @subpackage Rimplenet_Templates/public
 */
 ...
 */
class Rimplenet_Templates_Public {
	...
	public function __construct( $plugin_name, $version ) {
        ...
        add_shortcode('rimplenet-template', array($this, 'RetrieveTemplate'));
	...
	public function LoadTemplateFunctions() {
        ...
        global $post;
        if ( is_a( $post, 'WP_Post' ) && has_shortcode( $post->post_content, 'rimplenet-template') ) {
            
            $pattern = get_shortcode_regex();
            preg_match_all('/'. $pattern .'/s', $post->post_content, $matches); 
            foreach($matches[0] as $match){
              
             if(has_shortcode( $match, 'rimplenet-template')){
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/rimplenet-templates-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/rimplenet-templates-public.js', array( 'jquery' ), $this->version, false );
