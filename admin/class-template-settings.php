...
class Rimplenet_Template_Settings{
    ...
    public function __construct() {
        ...
        //add_action('save_post_rimplenettransaction',  array($this,'save_settings'), 10,3 );
    ...
    function rimplenet_template_register_meta_box() {
        ...
        add_meta_box( 'rimplenet-admin-wallet-settings-meta-box', esc_html__( 'Wallet Settings', 'rimplenet' ),   array($this,'rimplenet_admin_wallet_meta_box_callback'), 'rimplenettemplate', 'normal', 'high' );
