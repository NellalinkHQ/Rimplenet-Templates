 ...
 * Plugin URI:        https://rimplenet.com/templates
 * Description:       This is a short description of what the plugin does. It's displayed in the WordPress admin area.
 * Version:           1.0.4
 * Author:            Nellalink
 * Author URI:        https://rimplenet.com/templates
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       rimplenet-templates
 ...
 */
define( 'RIMPLENET_TEMPLATES_VERSION', '1.0.0' );
...
register_deactivation_hook( __FILE__, 'deactivate_rimplenet_templates' );

/**
 * The core plugin class that is used to define internationalization,
 * admin-specific hooks, and public-facing site hooks.
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-rimplenet-templates.php';
